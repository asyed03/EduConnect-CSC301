...
def add_announcement_endpoints(server: Flask, request_manager: AnnouncementRequestManager, comment_request_manager: AnnouncementCommentRequestManager):
    ...
    server.add_url_rule("/announcements/upvote", "upvote-announcement", methods=["POST"], view_func=request_manager.post_upvote_announcement)
    #server.add_url_rule("/announcements/downvote", "downvote-announcement", methods=["POST"], view_func=request_manager.post_downvote_announcement)    

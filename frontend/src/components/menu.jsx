    ...
    <>
      <div className="menu">
        <div className="menu-left">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="green" class="bi bi-list" viewBox="0 0 16 16" onClick={() => setExpanded(!expanded)}>
      ...
      <div className={`left-menu ${expanded ? "expanded" : ""}`}>
        ...
        <Link to="/dashboard" className="menu-item">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="green" class="bi bi-grid" viewBox="0 0 16 16">
        ...
        <Link to="/messages" className="menu-item">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="gray" class="bi bi-chat-left-dots" viewBox="0 0 16 16">
        ...
        <Link to="/profile-settings" className="menu-item">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="gray" class="bi bi-gear" viewBox="0 0 16 16">
